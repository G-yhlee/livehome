defmodule Server.Point do
  ...
  # def locate({x, y}, {change_x, change_y}) do
  #   {x + change_x, y + change_y}
  # end
  @spec transpose({any, any}) :: {any, any}
  ...
  def in_bounds?({x, _y}) when x > 15, do: false
  def in_bounds?({_x, y}) when y > 15, do: false
