defmodule StockWeb.Mylib.V2 do
  alias StockWeb.Mylib.Link2
  # alias StockWeb.Helper.H
  def get_data_by_ticker_of_intraday(ticker) do
    Link2.parse_link_by_ticker_and_type(ticker,:intraday)
  end
  ...
  def get_data_by_ticker_of_cap(ticker) do
    Link2.parse_link_by_ticker_and_type(ticker,:cap)
    # |> Enum.at(at)
  end
  def list_ticker do
